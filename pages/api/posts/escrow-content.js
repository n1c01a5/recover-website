export const EscrowBlogContent = `
    <div class="escrow-container">
      ...
      <section class="blog__section">
        ...
        <img class="content-image" src="../Blog_1_Transaction_works.jpg" alt="How Escrow Financial Transaction Works?" />
      ...
      <section class="blog__section">
        ...
        <img class="content-image" src="../Blog_1_Smart_contract.png" alt="Can you see the future with those contracts?" />
      ...
      <section class="blog__section">
        ...
        <img class="content-image" src="../Blog_1_Kleros_contract.jpg" alt="When the transactions has a low-price and high security, it is here to stay" />
        ...
        <h3 class="sub-title">Less Arbitratation fees (if the gas is affordable :p) </h2>
        <p class="content">
          ...
          Decntralized arbitrators like Kleros is affordable as decentralised arbitration
