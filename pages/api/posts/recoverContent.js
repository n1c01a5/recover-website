...
<div class="recoverPhoneContainer">
    <section class="heroSection">
      <p>
        ...
        personal life which cannot be replaced easily no matter what the cost
      ...
      <p>
        ...
        looking at all your data can drive you crazy. Fortunately, it is
        possible to find your phone and to prevent the loss of your data and
        sleep.
      </p>
      <p>
        Let’s look at 3 steps that you can follow in case of loss and 2 tools
        that can help insure the recovery in case of loss.
      </p>
    ...
    <section class="section1">
      ...
      <p>
        ...
        Perhaps it is possible you have misplaced it somewhere near you and you
        can hear the snooze or beep sound to retrieve it easily.
      </p>
      <p>
      ...
      <p>
        Retracing your steps can help you find your phone if you are sure you
        did not lose it in a busy area like airports, railway stations,
        restaurants, etc.. This way the chances are high that no one saw your
        phone lying unattended and you can find it by retracing your steps. It
        is important to keep in mind that you have to avoid panic. Panicking can
        worsen the situation and you can have trouble remembering the last
        location of your phone. If you were in a restaurant or shop before
        losing it, ask an employee if anyone found or reported a lost phone. If
      ...
      <p>
        ...
        with phone GPS service. For this feature to run smoothly you should have
        this feature activated on your device so it can be accessed from another
      ...
      <div class="measures-div">
        ...
        <ul>
          <li>
            ...
            <p>
              If you are sure that your device has been stolen, do not try to
              recover it yourself. Call the police and let them handle the
              situation for you. Going after the thief by yourself can be
              dangerous for you. Report the theft to the nearest police station:
              A police report will be required to submit a claim file to your
              insurer. To disable your number, some phone operators will also
              ask you for this report.
            </p>
          </li>
          <li>
            <h3>Reset your passwords and login information: </h3>
            <p>
              Perhaps the most important measure to take to limit the damage.
              Irrespective of your usage of the phone, go on the Internet, you
              will need to reset your passwords and login information as soon as
              possible. For some people, it may not be necessary, but for
              others, the risk could be considerable. First, change your most
              important passwords like bank accounts and then change email
              passwords, social media, etc. You may also need to immediately
              cancel credit cards or debit cards registered online from this
              device (for example, cards stored on the App Store).
            </p>
          </li>
          <li>
            <h3>Contact your telephone company: </h3>
            <p>
              Keep your account information handy so you can close it. If you
              have set a password or access code for your account, you will also
              need it. Disabling your SIM card will prevent the thief (or the
              person who found your phone) making calls using your number. If
              you have a postpaid plan and you were not able to find your phone
              within 2 hours, call your telephone company right away and ask
              them to deactivate your number.
            </p>
          </li>
        </ul>
        <p>
          Lost phones are sometimes returned, but their owners no longer claim
          them because they think no one would be nice enough to return them.
        </p>
      </div>
    </section>
    <section class="section-4">
      ...
      <p>
        Tile offers a wide range of products which match your product needs. By
        attaching a tile (a hardware device) to a keychain or other item, a user
      ...
      <p>
        ...
        box using the technology which is used to safeguard the valuables.
      </p>
      ...
      <p>
        ...
        as a reward for the finder.
      </p>
      <h4>Technology behind Recover</h4>
      <p>
        Recover is the first lost and found service provider which uses
        Blockchain technology for product insurance. It ensures the Recovery of
        the product as it offers a reward for the finder who on seeing the
        reward (which is capped higher than the market price) is incentivized to
        return the product to the owner. Alongside, Recover uses smart contracts
        to add more privacy, security and transparency to the transactions.
      </p>
