        ...
        <header>
            ...
            >
              <div>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between', width: '500px', marginTop: '50px' }}>
                  ...
                  <Link href='/loser-box'>
                    <div><Button isPrimary>Get your Loser Box</Button></div>
                  </Link>
                </div>
              </div>
          ...
          <div className='mobile-layout'>
            <div style={{ display: 'flex', flexDirection: 'column', width: '100vw', marginTop: '-40px' }}>
              ...
              <div style={{ textAlign: 'center', marginTop: '20px' }}><Button isPrimary isSmallFormat>Get your Loser Box</Button></div>
            </div>
          </div>
        </header>
      </div>
          ...
          <div className='mobile-layout'>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', margin: '0 20px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                ...
                <div style={{ textAlign: 'center', marginTop: '-40px' }}><Button isPrimary isSmallFormat>Get your Loser Box</Button></div>
