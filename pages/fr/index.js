    ...
    <Layout>
          ...
          <div className="desktop-layout">
            ...
            >
              <div>
                <h1>
                  Service d'
                  <span style={{ color: '#12c2e9' }}>Objets Trouvés</span>,
                  <br />
                  pour retrouver&nbsp;
                ...
                >
                  <div>
                    <Button>Comment ca marche?</Button>
                  </div>
                  <div>
                    <Button isPrimary>Obtenir sa Loser Box</Button>
                  </div>
                </div>
              </div>
              <div>
            ...
            <div
              style={{
                ...
                padding:
                  '0 calc((100vw - 1250px) / 2) 2px calc((100vw - 1250px) / 2)',
      ...
      <div>
        <section>
          <div className="desktop-layout">
            <h2
              style={{
                fontWeight: '600',
                fontSize: '28px',
                padding: '0 calc((100vw - 1250px + 160px) / 2)'
              }}
            >
              <span style={{ color: '#12c2e9' }}>Comment</span> retrouver mes
              objets de valeur?
            </h2>
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              <div
                style={{
                  display: 'flex',
                  padding:
                    '80px calc((100vw - 1250px + 160px) / 2) 0 calc((100vw - 1250px + 160px) / 2)'
                }}
              >
                <div
                  style={{
                ...
                >
                  <div>
                    ...
                    >
                      Ajouter un QrCode Recover avec une récompense sur vos
                      objets de valeur pour inciter la personne qui le trouve à
                      te le retourner.
                    </p>
                  </div>
                  <div
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      Si l'objet est perdu, celui qui l'a trouvé est incité à le
                      rendre pour avoir la récompense.
                    </p>
                  </div>
                  <div
                    style={{
              ...
              >
                ...
                >
                  <div>
                    ...
                    >
                      Après une prise de contact, vous pouvez échanger la
                      récompense contre l'object perdu.
                    </p>
                  </div>
                  <div
                    style={{
          ...
          <div className="mobile-layout">
            ...
            >
              <span style={{ color: '#12c2e9' }}>Comment</span> protéger ses
              objets de valeur de la perte?
            </h2>
            <div
              style={{
                display: 'flex',
            ...
            >
              ...
              <div>
                ...
                >
                  Ajouter un QrCode Recover avec une récompense sur vos objets
                  de valeur pour inciter la personne qui le trouve à te le
                  retourner.
                </p>
              </div>
              ...
              <div>
                ...
                >
                  Après une prise de contact, vous pouvez échanger la récompense
                  contre l'object perdu.
                </p>
              </div>
            </div>
            <h2
            ...
            >
              <span style={{ color: '#12c2e9' }}>Pourquoi</span> Choisir Recover
              comme service d'Objets Perdus?
            </h2>
            <div
              style={{
                display: 'flex',
            ...
            >
              <div>
                ...
                <p style={{ padding: '20px 0' }}>
                  Ajouter un simple QrCode pour Retrouver plus facilement vos
                  Objets de valeur.
                </p>
              </div>
              <div style={{ textAlign: 'right' }}>
                ...
                <p style={{ padding: '20px 0' }}>
                  Grâce à une Récompense, tu as plus de chance de Retrouver ton
                  Objet de valeur.
                </p>
              </div>
              <div>
                ...
                <p style={{ padding: '20px 0' }}>
                  Tes données personnelles sont seulement accessibles par le
                  propriétaire et celui qui le trouve, et par personne d'autre.
                </p>
              </div>
              <div style={{ marginTop: '40px' }}>
                <h3 style={{ textAlign: 'center' }}>
                  ...
                  />
                  <br />
                  Expérimenter la Blockchain avec Recover
                </h3>
                <p style={{ padding: '20px 0' }}>
                  Recover est un projet qui te permet de tester certaines
                  possibilités de la Blockchain:
                </p>
                <p
                  style={{
                    borderLeft: '2px solid #a6ffcb',
                    paddingLeft: '10px'
                  }}
                >
                  The Blockchain User Experience (workflow, tools, libraries...)
                  for regular and cryptoenthousiast user.
                </p>
                <p
                  style={{
                    marginTop: '20px',
                ...
                >
                  The trust for the transactions between parties (seller/buyer,
                  finder/owner) thanks to the escrow technology.
                </p>
                <p
                  style={{
                    marginTop: '20px',
              ...
              <h2
                style={{
                  ...
                  fontSize: '22px',
                  textAlign: 'center',
                  margin: '60px 18px 30px 18px'
                }}
              >
                Voir la <span style={{ color: '#12c2e9' }}>Loser Box</span>{' '}
                maintenant!
              </h2>
              <div
                style={{
              ...
              >
                ...
                <div style={{ textAlign: 'center', marginTop: '-40px' }}>
                  <Button isPrimary isSmallFormat>
                    Obtenir ta Loser Box
                  </Button>
                </div>
                <div>
                  <p style={{ marginTop: '20px' }}>
                    <a style={{ textDecoration: 'underline' }}>
                      Ou tester gratuitement
                    </a>
                  </p>
                </div>
              </div>
            ...
            >
              ...
              >
                <div style={{ flex: '1' }}>
                  ...
                  >
                    Grâce à une Récompense, tu as plus de chance de Retrouver
                    ton Objet de valeur.
                  </p>
                </div>
                <div style={{ flex: '1' }}>
                ...
                <div style={{ flex: '1' }}>
                  ...
                  >
                    Tes données personnelles sont seulement accessibles par le
                    propriétaire et celui qui le trouve, et par personne
                    d'autre.
                  </p>
                </div>
              </div>
      ...
      >
        <section>
          ...
          >
            Take a look on the{' '}
            <span style={{ color: '#12c2e9' }}>Loser Box</span>!
          </h2>
          <div
            style={{
              display: 'flex',
        ...
        <section>
          <h2
            style={{
              ...
              fontSize: '28px',
              padding:
                '130px calc((100vw - 1250px + 160px) / 2) 50px calc((100vw - 1250px + 160px) / 2)'
            }}
          >
